...
values
('my_client_id', 'my_client_secret', null, 'read,write', 'authorization_code,password,client_credentials,implicit,refresh_token', null, 'ROLE_MY_CLIENT', 36000, 2592000, null, null)
;
...
values
('your_client_id', 'your_client_secret', null, 'read', 'authorization_code,password', null, 'ROLE_YOUR_CLIENT', 36000, 2592000, null, null)
;
